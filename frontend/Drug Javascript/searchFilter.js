function loadDrugID(id){
    ...
    //$('#patient_list').append(showSearch())
      ...
      fetch(baseURL + '/drugs/searchByID/'+id, {headers: {'Authorization': 'Basic ' + code}})
      .then((res) => res.json())
      .then((json) => {
          console.log(json)
...
function loadDrugByName(id){
    ...
    //$('#patient_list').append(showSearch())
      ...
      fetch(baseURL + '/drugs/searchByName?name='+id, {headers: {'Authorization': 'Basic ' + code}})
      .then((res) => res.json())
      .then((json) => {
          console.log(json)
