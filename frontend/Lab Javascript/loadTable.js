function loadLabs(){
    $('#lab_list').html('')
    //$('#lab_list').append(showSearch())

    fetch(baseURL + '/labs', {headers: {'Authorization': 'Basic ' + code}})
    .then((res) => res.json())
    .then((json) => {
...
var str = '<tr>\
          ...
          <th scope="col">\
              <input type="text" class="form-control input-sm" id="myInput1" onkeyup="searchService()" placeholder="Service">\
          </th>\
          <th></th>\
          <th></th>\
          </tr>'
