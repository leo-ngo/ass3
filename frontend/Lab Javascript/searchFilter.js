function loadLabID(id){
    ...
    //$('#patient_list').append(showSearch())
      ...
      fetch(baseURL + '/labs/searchByID/'+id, {headers: {'Authorization': 'Basic ' + code}})
      .then((res) => res.json())
      .then((json) => {
          console.log(json)
...
function loadLabByService(id){
    ...
    //$('#patient_list').append(showSearch())
      ...
      fetch(baseURL + '/labs/searchByService?service='+id, {headers: {'Authorization': 'Basic ' + code}})
      .then((res) => res.json())
      .then((json) => {
          console.log(json)
